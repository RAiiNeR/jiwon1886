...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(
                List.of("http://localhost:81/traveler/", "http://192.168.0.88:81/traveler/", "http://192.168.0.88/",
                        "http://localhost:3001/traveler/", "http://localhost:3001/", "http://localhost:3001"));
