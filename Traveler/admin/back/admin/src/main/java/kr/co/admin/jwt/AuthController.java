...
import kr.co.admin.manager.EmailSenderDTO;
import kr.co.admin.manager.EmailSenderService;
import kr.co.admin.manager.ManagerService;
...
public class AuthController {
    ...
    // 인증번호 확인
    @PostMapping("/sendKey")
    public ResponseEntity<?> hotkey(@RequestParam("sabun") String sabun) {
        String email = managerService.getEmail(sabun);
    ...
    // 인증번호 확인
    @PostMapping("/hotkey")
    public boolean hotkey(@RequestParam("key") String key, @RequestParam("sabun") String sabun) {
        String email = managerService.getEmail(sabun);
        return emailSenderService.isVerify(email, key);
    }
