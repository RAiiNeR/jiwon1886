...
public class JwtTokenProvider {
    ...
    public String createToken(Authentication authentication) {
        ...
        Manager manager = managerService.getManager(userDetails.getUsername()); 
        String managerName = manager.getName();
        String sabun = manager.getSabun();
        Long managerNum = manager.getNum();
        String imgname = manager.getImgname();
