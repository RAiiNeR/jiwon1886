        ...
        <div className="header-div">
            <div className='header-top'>
                {
                    isLoggedIn ? (
                        ...
                        <div className='login'>
                            <Link to='/noorigun/login'>로그인</Link>
                        </div>
                    )
                }
            </div >
            <header>
                <nav className='navbar navbar-expand-md navbar-light p-0 d-flex flex-wrap align-items-center justify-content-between'>
                    <Link to="/noorigun" className="d-flex align-items-center my-2 me-3">
                            ...
                            <ul className='navbar-nav my-0 mx-auto p-0 list-unstyled fs-4 d-flex justify-content-evenly align-items-center'>
                                <li className='mx-1 text-center nav-item nav-hover'>
                                    ...
                                    <ul className='nav-hover-menu'>
                                        <li><Link to='/noorigun/nooriGunEmployee'>조직도</Link></li>
                                        <li><hr /></li>
                                        <li><Link to='/noorigun/complaintProcese'>신청 절차</Link></li>
                                    </ul>
                                </li>
                                <li className='mx-1 text-center nav-item nav-hover'>
                                    <Link to='#'>소통⦁참여</Link>
                                    <ul className='nav-hover-menu'>
                                        <li><Link to='/noorigun/suggestion'>제안목록</Link></li>
                                        <li><hr /></li>
                                        <li><Link to='/noorigun/qna'>질문/답변</Link></li>
                                        <li><hr /></li>
                                        <li><Link to='/noorigun/survey'>설문조사</Link></li>
                                    </ul>
                                </li>
                                <li className='mx-1 text-center nav-item nav-hover'>
                                    <Link to='#'>민원현황</Link>
                                    <ul className='nav-hover-menu'>
                                        <li><Link to='/noorigun/comple'>민원현황</Link></li>
                                        <li><hr /></li>
                                        <li><Link to='/noorigun/comple/chart'>부서별 민원통계</Link></li>
                                    </ul>
                                </li>
                                <li className='mx-1 text-center nav-item nav-hover'>
                                    <Link to='#'>누리소식</Link>
                                    <ul className='nav-hover-menu'>
                                        <li><Link to='/noorigun/promote'>누리행사</Link></li>
                                        <li><hr /></li>
                                        <li><Link to='/noorigun/faq'>자주하는 질문</Link></li>
                                    </ul>
                                </li>
                                <li className='mx-1 text-center nav-item nav-hover'>
                                    <Link to="#">시민 공간</Link>
                                    <ul className='nav-hover-menu'>
                                        <Link to='/noorigun/freeboard'>자유게시판</Link>
                                        <li><hr /></li>
                                        <li><Link to='/noorigun/program'>강좌 신청</Link></li>
                                        <li><hr /></li>
                                        <li><Link to='/noorigun/rent'>비품 대여</Link></li>
                                    </ul>
                                </li>

                                {
                                    isLoggedIn ? (
                                        <>
                                            <li className='mx-1 text-center nav-item nav-hover'>
                                                <Link to={`/noorigun/mypage/${username}`}>나의 누리</Link>
                                            </li>
