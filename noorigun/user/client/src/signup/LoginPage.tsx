...
const LoginPage: React.FC = () => {
  ...
  const redirectPath = new URLSearchParams(location.search).get('redirect') || '/noorigun';
            ...
            <div className="content">
              <div id="login_content">
                ...
                <div className="menbership" id="login_bottom1" style={{ textAlign: "center", display: selPasswordNo !== 3 ? 'block' : 'none' }}>
                  <Link to='/noorigun/signup'>회원가입</Link>
              ...
              <div className='text-center'>
                <h6>소셜 로그인</h6>
                <Link to="/noorigun/kakaologin"><img src="images/button_img/kakao_login.png" alt="" className='w-100' /></Link>
              </div>
            </div>
          </div >
        </div >
