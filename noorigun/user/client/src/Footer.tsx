            ...
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <div className='mx-auto'>
                    <ul className='my-2 p-0 d-flex flex-wrap align-items-center justify-content-center list-unstyled '>
                        ...
                        <li className='float-start m-1'><a href="/noorigun/faq" className='text-decoration-none'>자주하는질문</a></li>|
                        <li className='float-start m-1'><a href="#" className='text-decoration-none'>이메일무단수집거부</a></li>|
                        <li className='float-start m-1'><a href="/noorigun/directions" className='text-decoration-none'>오시는길</a></li>|
