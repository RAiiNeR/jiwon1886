...
interface ModalProps {
  ...
  const isMainPage = window.location.pathname === '/noorigun/';
  // console.log(isMainPage, window.location.pathname);
    ...
    return (
      <Portal elementId="modal-root">
        ...
        <ModalWrapper className={className} visible={visible} onClick={(e) => e.stopPropagation()}>
          <ModalInner>
            <ImgStyle>
              <Link to={`/noorigun/program/${num}`} rel="noopener noreferrer" target="_blank">
