...
const FreeboardDetail: React.FC = () => {
    ...
    useEffect(() => {
        const getDetail = async () => {
            ...
            try {
                const response = await axios.get(`${process.env.REACT_APP_BACK_END_URL}/api/freeboard/detail?num=${num}`);
            ...
            <div style={{ padding: '50px' }}>
                <div className="reply-container">
                    <div className="post-content">
                        ...
                        <p></p>
                        <div className='btns'>
                            <button className='btn btn-primary'><Link to={'/noorigun/freeboard'}>BACK</Link></button>
