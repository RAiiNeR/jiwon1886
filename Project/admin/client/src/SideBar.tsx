        ...
        <>
            {
                isLoggedIn && (
                    <div className="flex-shrink-0 p-3 side-bar">
                        <a href="/" className="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom main-icon">
                        ...
                        <ul className="list-unstyled ps-0">
                                    ...
                                    <li className="mb-1">
                                        ...
                                        <div className="collapse" id="userchart-collapse">
                                            <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                <li><a href="/chart/member" className="link-dark rounded">이용자 통계</a></li>
                                                <li><a href="/chart/comple" className="link-dark rounded">민원 통계</a></li>
                                                <li><a href="/chart/vote" className="link-dark rounded">투표 통계</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                )
                                ...
                                (role === 'ADMIN' || role === 'SUPERVISOR' || role === 'MANAGER') && (
                                    <li className="mb-1">
                                        ...
                                        <div className="collapse" id="user-collapse">
                                            <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                <li><a href="/member" className="link-dark rounded">사용자 목록</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                )
                                ...
                                (role === 'ADMIN' || role === 'SUPERVISOR') && (
                                    <li className="mb-1">
                                        ...
                                        <div className="collapse" id="admin-collapse">
                                            <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                <li><a href="/manager" className="link-dark rounded">관리자 목록</a></li>
                                                <li><a href="/manager/new" className="link-dark rounded">관리자 추가</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                )
                            ...
                            <li className="mb-1">
                                ...
                                <div className="collapse" id="board-collapse">
                                    <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                        <li><a href="/comple" className="link-dark rounded">민원게시판</a></li>
                                        <li><a href="/suggest" className="link-dark rounded">제안게시판</a></li>
                                        <li><a href="/promote" className="link-dark rounded">행사게시판</a></li>
                                        <li><a href="/faq" className="link-dark rounded">자주하는 질문</a></li>
                                        <li><a href="/qna" className="link-dark rounded">QnA게시판</a></li>
                                        <li><a href="/freeboard" className="link-dark rounded">자유게시판</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li className="mb-1">
                                ...
                                <div className="collapse" id="other-collapse">
                                    <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                        <li><a href="/banner" className="link-dark rounded">배너 목록</a></li>
                                        <li><a href="/survey" className="link-dark rounded">설문 목록</a></li>
                                        <li><a href="/program" className="link-dark rounded">강좌 관리</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li className="mb-1">
                                ...
                                <div className="collapse" id="account-collapse">
                                    <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                        ...
                                        {
                                            (role === 'ADMIN' || role === 'SUPERVISOR' || role === 'MANAGER') && (
                                                <li><Link to="/noti/new" className="link-dark rounded">공지등록</Link></li>
                                            )
                                        }
                                    </ul>
                                </div>
